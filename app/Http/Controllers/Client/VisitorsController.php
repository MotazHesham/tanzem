...
class VisitorsController extends Controller
{
    ...
    { 
        if ($request->ajax()) {
            ...
            $query = Visitor::with(['user', 'brands'])
                            ->whereHas('events', function ($query) use ($client_id){
        ...
        return view('client.visitors.index');
    }
    ...
    {   
        ...
        return view('client.visitors.create', compact('users', 'events', 'brands'));
    }
    ...
    { 
        ...
        return redirect()->route('client.visitors.index');
    }
    ...
    { 
        ...
        return view('client.visitors.edit', compact('users', 'events', 'brands', 'visitor'));
    }
    ...
    { 
        ...
        return view('client.visitors.show', compact('visitor'));
    }
