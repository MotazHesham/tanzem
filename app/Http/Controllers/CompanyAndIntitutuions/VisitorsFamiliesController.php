...
class VisitorsFamiliesController extends Controller
{
    ...
    {  
        ...
        //return view('company.visitorsFamilies.index', compact('visitorsFamilies'));
    }
    ...
    { 
        ...
        //return view('company.visitorsFamilies.create', compact('visitors'));
    }
    ...
    public function store(StoreVisitorsFamilyRequest $request)
    {
        ...
        return redirect()->route('company.visitors.show',$visitorsFamily->visitor_id);
    }
    ...
    { 
        ...
        return view('company.visitorsFamilies.edit', compact('visitors', 'visitorsFamily'));
    }
