...
class CompaniesAndInstitutionsController extends Controller
{
    public function index()
    {
        ...
        $companiesAndInstitutions = CompaniesAndInstitution::with(['user', 'specialization'])->get();
    ...
    public function create()
    {
        ...
        $specializations = Specialization::pluck('name_ar', 'id')->prepend(trans('global.pleaseSelect'), '');
    ...
    public function edit(CompaniesAndInstitution $companiesAndInstitution)
    {
        ...
        $companiesAndInstitution->load('user', 'specialization');
