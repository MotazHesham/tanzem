...
class BrandsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $events = Event::where('government_id',$government->id)->get()->pluck('id')->prepend(trans('global.pleaseSelect'), '');
            ...
            $table->editColumn('actions', function ($row) { 
                $crudRoutePart = 'government.brands';
        ...
        return view('government.brands.index');
    }

    public function create()
    {  
        $government = GovernmentalEntity::where('user_id',Auth::id())->first();
        $events = Event::where('government_id',$government->id)->get()->pluck('title', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('government.brands.create', compact('events'));
    }
    ...
    public function store(StoreBrandRequest $request)
    {
        ...
        return redirect()->route('government.brands.index');
    }
    ...
    { 
        ...
        return view('government.brands.edit', compact('events', 'brand'));
    }
    ...
    public function show(Brand $brand)
    {
        ...
        return view('government.brands.show', compact('brand'));
    }
