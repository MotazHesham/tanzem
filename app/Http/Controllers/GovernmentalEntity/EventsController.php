...
class EventsController extends Controller
{
    ...
    { 
        ...
        if ($request->ajax()) {
            ...
            $query = Event::where('government_id',$government->id)->with(['city', 'government.user', 'available_gates','specializations'])->select(sprintf('%s.*', (new Event())->table));
            ...
            $table->editColumn('actions', function ($row) { 
                $crudRoutePart = 'government.events';
            ...
            $table->rawColumns(['actions', 'placeholder', 'government', 'date', 'time', 'status', 'available_gates','specializations']);

            return $table->make(true);
        }

        return view('government.events.index');
    }
    ...
    public function store(StoreEventRequest $request)
    {
        ...
        return redirect()->route('government.events.index');
    }
    ...
    public function show(Event $event)
    {
        ...
        $event->load('city', 'company', 'available_gates', 'specializations', 'cawaders', 'reviews', 'government', 'government', 'eventBrands', 'eventsVisitors');

        return view('government.events.show', compact('event'));
    }
