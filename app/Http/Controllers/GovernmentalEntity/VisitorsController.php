...
class VisitorsController extends Controller
{
    ...
    { 
        if ($request->ajax()) {
            ...
            $query = Visitor::with(['user', 'brands'])
                            ->whereHas('events', function ($query) use ($government_id){
            ...
            $table->editColumn('actions', function ($row) { 
                $crudRoutePart = 'government.visitors';
        ...
        return view('government.visitors.index');
    }
    ...
    {   
        ...
        return view('government.visitors.create', compact('users', 'events', 'brands'));
    }
    ...
    { 
        ...
        return redirect()->route('government.visitors.index');
    }
    ...
    { 
        ...
        return view('government.visitors.edit', compact('users', 'events', 'brands', 'visitor'));
    }
    ...
    { 
        ...
        return view('government.visitors.show', compact('visitor'));
    }
