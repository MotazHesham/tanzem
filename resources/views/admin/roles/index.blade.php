                ...
                <tbody>
                    @foreach($roles as $key => $role)
                        <tr data-entry-id="{{ $role->id }}">
                            ...
                            <td> 
                                @can('role_show')
                                    <a href="{{ route('admin.roles.show', $role->id) }}" class="btn btn-outline-info btn-pill action-buttons-view" >
                                        <i  class="fas fa-eye actions-custom-i"></i>
                                    </a>
                                @endcan

                                @can('role_edit')
                                    <a  href="{{ route('admin.roles.edit', $role->id) }}" class="btn btn-outline-success btn-pill action-buttons-edit">
