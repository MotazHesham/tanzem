...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.companiesAndInstitution.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.companies-and-institutions.store') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.companiesAndInstitution.fields.city_helper') }}</span>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.companiesAndInstitution.fields.twitter_helper') }}</span>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.companiesAndInstitution.fields.facebook_helper') }}</span>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="gmail">{{ trans('cruds.companiesAndInstitution.fields.gmail') }}</label>
                                <input class="form-control {{ $errors->has('gmail') ? 'is-invalid' : '' }}" type="text"
                                    name="gmail" id="gmail" value="{{ old('gmail', '') }}">
                                @if ($errors->has('gmail'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('gmail') }}
                                    </div>
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.companiesAndInstitution.fields.gmail_helper') }}</span>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="linked">{{ trans('cruds.companiesAndInstitution.fields.linked') }}</label>
                                <input class="form-control {{ $errors->has('linked') ? 'is-invalid' : '' }}" type="text"
                                    name="linked" id="linked" value="{{ old('linked', '') }}">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.companiesAndInstitution.fields.linked_helper') }}</span>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.companiesAndInstitution.fields.instagram_helper') }}</span>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control date {{ $errors->has('commerical_expiry') ? 'is-invalid' : '' }}"
                                    type="text" name="commerical_expiry" id="commerical_expiry"
                                    value="{{ old('commerical_expiry') }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control date {{ $errors->has('licence_expiry') ? 'is-invalid' : '' }}"
                                    type="text" name="licence_expiry" id="licence_expiry" value="{{ old('licence_expiry') }}"
                                    required>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="needsclick dropzone {{ $errors->has('galery') ? 'is-invalid' : '' }}"
                                id="galery-dropzone">
                            </div>
                            ...
                            @endif
                            <span
                                class="help-block">{{ trans('cruds.companiesAndInstitution.fields.galery_helper') }}</span>
                        </div>
                        <div class="form-group ">
                            <label for="videos">{{ trans('cruds.companiesAndInstitution.fields.videos') }}</label>
                            <div class="needsclick dropzone {{ $errors->has('videos') ? 'is-invalid' : '' }}"
                                id="videos-dropzone">
                            </div>
                            ...
                            @endif
                            <span
                                class="help-block">{{ trans('cruds.companiesAndInstitution.fields.videos_helper') }}</span>
                        </div>
