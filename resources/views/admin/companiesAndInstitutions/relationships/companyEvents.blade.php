...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-companyEvents">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($events as $key => $event)
                        <tr data-entry-id="{{ $event->id }}">
                            ...
                            <td>
                                @foreach($event->available_gates as $key => $item)
                                    <span class="badge badge-info">{{ $item->gate }}</span>
                                @endforeach
                            </td>
                            <td>
                                @can('event_show')
...
@endcan
  ...
  let table = $('.datatable-companyEvents:not(.ajaxTable)').DataTable({ buttons: dtButtons })
