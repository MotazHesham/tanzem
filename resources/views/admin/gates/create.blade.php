    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.gates.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gate') ? 'is-invalid' : '' }}" type="number" name="gate" id="gate" value="{{ old('gate', '') }}" step="1" required>
                @if($errors->has('gate'))
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control {{ $errors->has('zone_name') ? 'is-invalid' : '' }}" type="text"
                    name="zone_name" id="zone_name" value="{{ old('zone_name', '') }}" required>
...
@section('scripts')
@include('map_scripts.brands.create')
<script>
