...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.saidAboutTanzem.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.said-about-tanzems.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_position') ? 'is-invalid' : '' }}" type="text" name="job_position" id="job_position" value="{{ old('job_position', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('text_1') ? 'is-invalid' : '' }}" type="text" name="text_1" id="text_1" value="{{ old('text_1', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('text_2') ? 'is-invalid' : '' }}" name="text_2" id="text_2" required>{{ old('text_2') }}</textarea>
