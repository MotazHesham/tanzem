        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <div class="form-group">
                        <a class="btn btn-default" href="{{ route('government.visitors.index') }}">
        ...
        <div class="card">
            ...
            <div class="tab-content">
                <div class="tab-pane active" role="tabpanel" id="visitor_visitors_families">
                    @includeIf('government.visitors.relationships.visitorVisitorsFamilies', ['visitorsFamilies' => $visitor->visitorVisitorsFamilies])
                </div>
            </div>
        </div>
    </div>
