<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        <a class="btn btn-success" href="{{ route('government.brands.create') }}">
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            url: "{{ route('government.brands.massDestroy') }}",
