...
@section('content') 
        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('company.cawaders.create') }}">
    ...
    <script>
        $(function() {
            let dtButtons = $.extend(true, [], $.fn.dataTable.defaults.buttons)
                ...
                url: "{{ route('company.cawaders.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('company.cawaders.index') }}",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
                    ...
                    {
                        data: 'companies_and_institution_user_name',
                        name: 'companies_and_institution.user.name'
                    },
                    {
                        data: 'specialization',
                        name: 'specializations.name_ar'
                    },
                    {
                        data: 'actions',
