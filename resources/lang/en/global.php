...
return [
    ...
    'flash' => [
        ...
        'api' => [
            'no_event_for_now' => 'There are no events at the moment',
            'not_subscribed' => 'Not participating in this event',
            'success' => 'Sent succesfully',
            'canceled' => 'Canceled successfully',
            'attend_before' => 'You are already logged out for this event today',
            'must_attend_in_area' => ' Attendance must be registered within the scope of the event. You are far away ',
            'meter_from_area' => 'meters of range',
            'attend' => 'Attendance has been registered',
            'registered' => 'Your request sent successfully',
