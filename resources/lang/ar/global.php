...
return [
    ...
    'dashboard_widgets' => [
        ...
        'News' => 'الأخبار',
        'Clients' => 'المسؤلين',
        'Events Start' => 'بدء الفعالبات',
        'Governmental' => 'الجهات الحكومية المضافة مؤخرا',
        'Latest Clients' => 'العملاء المضافين مؤخرا',
        'Latest Companies' => 'الشركات المضافة مؤخرا',
    ],
    'flash' => [
        ...
        'api' => [
            'no_event_for_now' => 'لا يوجد فعاليات في الوقت الحالي',
            'not_subscribed' => 'غير مشترك في هذه الفعالية',
            'success' => 'تم الأرسال بنجاح',
            'canceled' => 'تم الألغاء بنجاح',
            'attend_before' => 'تم تسجل الأنصراف من قبل لهذة الفعالية هذا اليوم',
            'must_attend_in_area' => ' لابد من تسجيل الحضور داخل نظاق الفعالية انت علي بعد ',
            'meter_from_area' => 'متر من النطاق',
            'attend' => 'تم تسجيل الحضور',
            'registered' => 'تم أرسال طلبك للأنضمام بنجاح',
            ...
            'error_leave' => 'تم المغادرة من قبل',
